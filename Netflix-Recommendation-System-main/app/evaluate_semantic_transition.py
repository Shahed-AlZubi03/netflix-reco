...
def main():
    ...
    print('TF-IDF vs Semantic Recommender Report')
    print('-' * 110)
    header = (
    ...
    for profile in PROFILES:
        ...
        precision_delta = semantic_metrics['precision'] - baseline_metrics['precision']
        print(f'Precision delta (Semantic - TF-IDF): {precision_delta:+.3f}')
